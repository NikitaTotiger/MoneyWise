  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-950">
      <div className="absolute inset-0">
        ...
        <div className="absolute -right-20 top-30 h-80 w-80 rounded-full bg-cyan-500/20 blur-3xl" />
        <div className="absolute -bottom-25 left-[25%] h-96 w-96 rounded-full bg-blue-500/15 blur-3xl" />
      </div>
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center px-4 py-10">
        <div className="grid w-full max-w-6xl overflow-hidden rounded-3xl border border-white/10 bg-white/5 shadow-2xl backdrop-blur-xl md:grid-cols-2">
          <div className="hidden flex-col justify-between bg-linear-to-br from-emerald-500/20 via-cyan-500/10 to-transparent p-10 text-white md:flex">
            <div>
            ...
            <div className="mx-auto w-full max-w-md">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full rounded-2xl bg-linear-to-r from-emerald-400 to-cyan-400 px-4 py-3 font-semibold text-slate-950 transition duration-200 hover:scale-[1.02] hover:shadow-lg hover:shadow-emerald-500/25 disabled:cursor-not-allowed disabled:opacity-70"
                >
